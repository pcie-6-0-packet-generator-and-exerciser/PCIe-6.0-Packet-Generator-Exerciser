...
string TLPHeader::getBitRep() const {
    ...
    boost::dynamic_bitset< nonBase->headerSizeInBytes*8 + OHCLength > result;
    
    result |= ((boost::dynamic_bitset<>(nonBase->headerSizeInBytes * 8, TLPtype) << ((nonBase->headerSizeInBytes * 8) - 8) );//cast to int
