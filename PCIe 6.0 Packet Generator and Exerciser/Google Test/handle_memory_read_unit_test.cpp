...
TEST(MemoryReadRequests, memoryReadRequest32) {
    ...
    TLP request = tlpRequest->createMemRead32Tlp(0, 0, 0x1000, std::bitset<4>(0b1111), std::bitset<4>(0b1111));
    ...
    expectedCompletion->createCplDTlp(
		...
		0, // deviceNumber
		0, // functionNumber
		0, // destinationSegment
		0, // completerSegment
		std::bitset<2>(0b00), // lowerAddress
    ...
    EXPECT_EQ(completion, expectedCompletion);
}
...
TEST(MemoryReadRequests, memoryReadRequest64) {
    ...
    TLP request = tlpRequest->createMemRead64Tlp(0, 0, 0x1000, std::bitset<4>(0b1111), std::bitset<4>(0b1111));
