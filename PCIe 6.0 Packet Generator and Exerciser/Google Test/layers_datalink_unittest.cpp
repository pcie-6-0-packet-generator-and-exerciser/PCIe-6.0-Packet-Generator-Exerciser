...
TEST(UpdateCreditLimit, SetPSharedCreditLimitFC1) {
	...
	bool FI1 = false;
	bool FI2 = false;
	int PSharedCreditLimit[2] = {-1, -1};
	int NPSharedCreditLimit[2] = {-1, -1};
	int CplSharedCreditLimit[2] = {-1, -1};
	int PDedicatedCreditLimit[2] = {-1, -1};
	int NPDedicatedCreditLimit[2] = {-1, -1};
	int CplDedicatedCreditLimit[2] = {-1, -1};
	Flit* flit = new Flit();
...
TEST(UpdateCreditLimit, SetNPSharedCreditLimitFC1) {
	...
	int CplDedicatedCreditLimit[2] = {-1, -1};
	Flit* flit = new Flit();
	Dllp dllp(1, 1, NPSharedCredit[1], NPSharedCredit[0], 0, true, Dllp::DllpType::initFC1, Dllp::CreditType::NP);
	flit->DLLPPayload = dllp.getBitRep();
	datalink.updateCreditLimit(flit, PSharedCreditLimit, NPSharedCreditLimit, CplSharedCreditLimit, PDedicatedCreditLimit, NPDedicatedCreditLimit, CplDedicatedCreditLimit, FI1, FI2);
...
TEST(UpdateCreditLimit, SetCplSharedCreditLimitFC1) {
	...
	int CplDedicatedCreditLimit[2] = {-1, -1};
	Flit* flit = new Flit();
	Dllp dllp(1, 1, CplSharedCredit[1], CplSharedCredit[0], 0, true, Dllp::DllpType::initFC1, Dllp::CreditType::Cpl);
	flit->DLLPPayload = dllp.getBitRep();
	datalink.updateCreditLimit(flit, PSharedCreditLimit, NPSharedCreditLimit, CplSharedCreditLimit, PDedicatedCreditLimit, NPDedicatedCreditLimit, CplDedicatedCreditLimit, FI1, FI2);
	EXPECT_EQ(PSharedCreditLimit[0], -1);
	EXPECT_EQ(PSharedCreditLimit[1], -1);
...
TEST(UpdateCreditLimit, SetPDedicatedCreditLimitFC1) {
	...
	int CplDedicatedCreditLimit[2] = {-1, -1};
	Flit* flit = new Flit();
	Dllp dllp(1, 1, PDedicatedCredit[1], PDedicatedCredit[0], 0, false, Dllp::DllpType::initFC1, Dllp::CreditType::P);
	flit->DLLPPayload = dllp.getBitRep();
	datalink.updateCreditLimit(flit, PSharedCreditLimit, NPSharedCreditLimit, CplSharedCreditLimit, PDedicatedCreditLimit, NPDedicatedCreditLimit, CplDedicatedCreditLimit, FI1, FI2);
	EXPECT_EQ(PSharedCreditLimit[0], -1);
	EXPECT_EQ(PSharedCreditLimit[1], -1);
...
TEST(UpdateCreditLimit, SetNPDedicatedCreditLimitFC1) {
	...
	int CplDedicatedCreditLimit[2] = {-1, -1};
	Flit* flit = new Flit();
	Dllp dllp(1, 1, NPDedicatedCredit[1], NPDedicatedCredit[0], 0, false, Dllp::DllpType::initFC1, Dllp::CreditType::NP);
	flit->DLLPPayload = dllp.getBitRep();
	datalink.updateCreditLimit(flit, PSharedCreditLimit, NPSharedCreditLimit, CplSharedCreditLimit, PDedicatedCreditLimit, NPDedicatedCreditLimit, CplDedicatedCreditLimit, FI1, FI2);
	EXPECT_EQ(PSharedCreditLimit[0], -1);
	EXPECT_EQ(PSharedCreditLimit[1], -1);
...
TEST(UpdateCreditLimit, SetCplDedicatedCreditLimitFC1) {
	...
	int CplDedicatedCreditLimit[2] = {-1, -1};
	Flit* flit = new Flit();
	Dllp dllp(1, 1, CplDedicatedCredit[1], CplDedicatedCredit[0], 0, false, Dllp::DllpType::initFC1, Dllp::CreditType::Cpl);
	flit->DLLPPayload = dllp.getBitRep();
	datalink.updateCreditLimit(flit, PSharedCreditLimit, NPSharedCreditLimit, CplSharedCreditLimit, PDedicatedCreditLimit, NPDedicatedCreditLimit, CplDedicatedCreditLimit, FI1, FI2);
	EXPECT_EQ(PSharedCreditLimit[0], -1);
	EXPECT_EQ(PSharedCreditLimit[1], -1);
...
TEST(UpdateCreditLimit, SetPSharedCreditLimitFC2) {
	...
	int CplDedicatedCreditLimit[2] = {-1, -1};
	Flit* flit = new Flit();
	Dllp dllp(1, 1, PSharedCredit[1], PSharedCredit[0], 0, true, Dllp::DllpType::initFC2, Dllp::CreditType::P);
	flit->DLLPPayload = dllp.getBitRep();
	datalink.updateCreditLimit(flit, PSharedCreditLimit, NPSharedCreditLimit, CplSharedCreditLimit, PDedicatedCreditLimit, NPDedicatedCreditLimit, CplDedicatedCreditLimit, FI1, FI2);
	EXPECT_EQ(PSharedCreditLimit[0], PSharedCredit[0]);
	EXPECT_EQ(PSharedCreditLimit[1], PSharedCredit[1]);
...
TEST(UpdateCreditLimit, SetNPSharedCreditLimitFC2) {
	...
	int CplDedicatedCreditLimit[2] = {-1, -1};
	Flit* flit = new Flit();
	Dllp dllp(1, 1, NPSharedCredit[1], NPSharedCredit[0], 0, true, Dllp::DllpType::initFC2, Dllp::CreditType::NP);
	flit->DLLPPayload = dllp.getBitRep();
	datalink.updateCreditLimit(flit, PSharedCreditLimit, NPSharedCreditLimit, CplSharedCreditLimit, PDedicatedCreditLimit, NPDedicatedCreditLimit, CplDedicatedCreditLimit, FI1, FI2);
	EXPECT_EQ(PSharedCreditLimit[0], -1);
	EXPECT_EQ(PSharedCreditLimit[1], -1);
...
TEST(UpdateCreditLimit, SetPDedicatedCreditLimitFC2) {
	...
	int CplDedicatedCreditLimit[2] = {-1, -1};
	Flit* flit = new Flit();
	Dllp dllp(1, 1, PDedicatedCredit[1], PDedicatedCredit[0], 0, false, Dllp::DllpType::initFC2, Dllp::CreditType::P);
	flit->DLLPPayload = dllp.getBitRep();
	datalink.updateCreditLimit(flit, PSharedCreditLimit, NPSharedCreditLimit, CplSharedCreditLimit, PDedicatedCreditLimit, NPDedicatedCreditLimit, CplDedicatedCreditLimit, FI1, FI2);
	EXPECT_EQ(PSharedCreditLimit[0], -1);
	EXPECT_EQ(PSharedCreditLimit[1], -1);
...
TEST(UpdateCreditLimit, SetNPDedicatedCreditLimitFC2) {
	...
	int CplDedicatedCreditLimit[2] = {-1, -1};
	Flit* flit = new Flit();
	Dllp dllp(1, 1, NPDedicatedCredit[1], NPDedicatedCredit[0], 0, false, Dllp::DllpType::initFC2, Dllp::CreditType::NP);
	flit->DLLPPayload = dllp.getBitRep();
	datalink.updateCreditLimit(flit, PSharedCreditLimit, NPSharedCreditLimit, CplSharedCreditLimit, PDedicatedCreditLimit, NPDedicatedCreditLimit, CplDedicatedCreditLimit, FI1, FI2);
	EXPECT_EQ(PSharedCreditLimit[0], -1);
	EXPECT_EQ(PSharedCreditLimit[1], -1);
...
TEST(UpdateCreditLimit, SetCplDedicatedCreditLimitFC2) {
	...
	int CplDedicatedCreditLimit[2] = {-1, -1};
	Flit* flit = new Flit();
	Dllp dllp(1, 1, CplDedicatedCredit[1], CplDedicatedCredit[0], 0, false, Dllp::DllpType::initFC2, Dllp::CreditType::Cpl);
	flit->DLLPPayload = dllp.getBitRep();
	datalink.updateCreditLimit(flit, PSharedCreditLimit, NPSharedCreditLimit, CplSharedCreditLimit, PDedicatedCreditLimit, NPDedicatedCreditLimit, CplDedicatedCreditLimit, FI1, FI2);
	EXPECT_EQ(PSharedCreditLimit[0], -1);
	EXPECT_EQ(PSharedCreditLimit[1], -1);
